  ...
  return (
    <div className="kiosk-container">
      ...
      <div className="main-menu">
        ...
        <MenuLink to="/u-nas" title="Atrakcje zimą" color="blue" />
        <MenuLink to="/u-nas" title="Atrakcje całoroczne" color="blue" />
        <MenuLink to="/u-nas" title="Kościół" color="blue" />
        <MenuLink to="/u-nas" title="Wycieczki" color="blue" />
      </div>
